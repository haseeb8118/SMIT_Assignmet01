"use strict";
const selectPages = document.getElementById("noOfRecords");
const storageContainer = document.getElementById("container");
    ...
    xhr.onload = () => {
        if (xhr.status === 200) {
            ...
            for (let i = 0; i < numberOfRecords; i++) {
                ...
                selectPages === null || selectPages === void 0 ? void 0 : selectPages.add(option);
            }
...
function renderTable(limit) {
    storageContainer === null || storageContainer === void 0 ? void 0 : storageContainer.replaceChildren();
    ...
    fetch(url).then(res => {
        ...
        storageContainer === null || storageContainer === void 0 ? void 0 : storageContainer.appendChild(tableElement);
    }).catch((error) => {
        errorMessage.innerHTML = error.message === "There was an error" ? "Please check your internet connection" : "";
        storageContainer === null || storageContainer === void 0 ? void 0 : storageContainer.appendChild(errorMessage);
    });
}
;
